...
<head>
    <base href="../../" />
    <title>Cashworxs API - Register</title>
    <meta charset="utf-8" />
    <meta name="description" content="Cashworxs API - Register" />
    <meta name="keywords" content="Cashworxs, API, register, account" />
                ...
                <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                    ...
                    <div class="d-flex flex-row-fluid flex-column text-center p-5 p-lg-10 pt-lg-10">
                        ...
                        <a href="/" class="py-2 py-lg-20">
                            <img alt="Logo" src="assets/media/logos/cashworxs.svg" class="h-40px h-lg-50px" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Title-->
                        <h1 class="d-none d-lg-block fw-bold text-white fs-2qx pb-5 pb-md-10">Welcome to Cashworxs
                        </h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                        <p class="d-none d-lg-block fw-semibold fs-2 text-white">
                            Unlock the power of seamless transactions and financial management.
            ...
            <div class="d-flex flex-column flex-lg-row-fluid py-10">
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid">
                    ...
                    <div class="w-lg-600px p-10 p-lg-15 mx-auto">
                        <!--begin::Form-->
                        <form class="form w-100" novalidate="novalidate" data-kt-redirect-url="/" id="kt_sign_up_form">
                            <!--begin::Heading-->
                            <div class="mb-10 text-center">
                                ...
                                <div class="text-gray-400 fw-semibold fs-4">Already have an account?
                                    <a href="{{ route('signin') }}" class="link-primary fw-bold">Sign in here</a>
                                </div>
                                <!--end::Link-->
                            </div>
                            <!--end::Heading-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input class="form-control form-control-lg form-control-solid" type="text"
                                    placeholder="" name="company-name" autocomplete="off" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
